...
$sources= array (
    'root' => $root,
    'build' => $root . '_build/',
    'source_core' => $root . 'core/components/quickemail',
    'source_assets' => $root . 'assets/components/quickemail',
    'data' => $root . '_build/data/',
    'docs' => $root . 'core/components/quickemail/docs/',
);
unset($root);
...
$builder->registerNamespace('quickemail',false,true,'{core_path}components/quickemail/');
...
$category->set('id',1);
$category->set('category','quickemail');
